...
while True :
    ...
    if inputan == 'exit' :
        print("\nAnda keluar dari sistem, terima kasih~")
        break
    ...
    if inputan == "5" : 
        if len(mahasiswa.info()) == 0 :
            ...
            print("Urutan mahasiswa dengan nilai tertinggi : ")
...
# mahasiswa_1.set_add_data()
# mahasiswa_1.hitung_nilai_akhir()
# print(mahasiswa_1.update_nilai('uas',[12,11,12]))
# print(mahasiswa_1.mengurutkan_mahasiswa())
